export default {
  ...
  NAME_PATTERN2: /^[a-zA-Z0-9 ]{1,}$/,
  NAME_PATTERN3:/^[a-zA-Z0-9, ]{1,}$/,
  ...
  TRIM_SPACE: /\s/g,
  LAT_REGEX:/^[+-]?(([1-8]?[0-9])(\.[0-9]{1,8})?|90(\.0{1,8})?)$/,
  LONG_REGEX:/^[+-]?((([1-9]?[0-9]|1[0-7][0-9])(\.[0-9]{1,8})?)|180(\.0{1,8})?)$/,
  ADDRESS_PATTERN: /^[a-zA-Z0-9\s\,\_\(\)\-\.\/]*$/,
  ONLY_CHARACTER_PATTERN: /([^0-9a-zA-Z ]+)/gi,
  CHARACTER_NAME_PATTERN: /([^a-zA-Z0-9 ])/gi,
  ADDRESS_NON_SPECIAL_CHARACTER: /[!@#$%^&*+\=\[\]{};':"\\|<>?]/
};
